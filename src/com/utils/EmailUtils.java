...
public class EmailUtils {  
    ...
    public static void main(String[] args) {
        String userName = "Dongcheng.Wei@desay-svautomotive.com"; // 发件人邮箱
        String smtpHost = "mail.desay-svautomotive.com"; 	  // 邮件服务器
  
        String to = "Dongcheng.Wei@desay-svautomotive.com"; //收件人，多个收件人以半角逗号分隔
        String subject = "冒烟测试结果";   // 主题  
        String body = "这是邮件的正文";     // 正文，可以用html格式的哟
        EmailUtils email = EmailUtils.entity(smtpHost, userName, null, to, null, subject, body, null);  
        try {
			email.send();
		} catch (Exception e1) {
			e1.printStackTrace();
    ...
    public void sendReportEmail(String from, String to, String bodyStr){
    	String userName = "Dongcheng.Wei@desay-svautomotive.com"; // 发件人邮箱
        String smtpHost = "mail.desay-svautomotive.com"; 	  // 邮件服务器
...
//        String to = "Dongcheng.Wei@desay-svautomotive.com"; //收件人，多个收件人以半角逗号分隔
        String subject = "冒烟测试结果";   // 主题  
//        String body = "这是邮件的正文";     // 正文，可以用html格式的哟
        EmailUtils email = EmailUtils.entity(smtpHost, from, null, to, null, subject, bodyStr, null);
        try {
			email.send();
		} catch (Exception e1) {
			e1.printStackTrace();
    ...
    private void init() {  
        ...
        props.put("mail.smtp.auth", "false"); // 是否需要身份验证  
